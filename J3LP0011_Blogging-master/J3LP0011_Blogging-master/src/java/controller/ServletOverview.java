...
/**
 * Lớp này có các phương thức thực hiện nhận yêu cầu của từ trang /overview để
 * phản hồi dữ liệu sang View.<p>
 * Bugs: Chưa xuất hiện
 *
 * @author King Wisdom
 */
@WebServlet(name = "ServletOverview", urlPatterns = {"/overview"})
public class ServletOverview extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ((pageNum > totalPage && totalPage != 0) || pageNum < 0) {
            response.sendRedirect("../myblog.com/overview");
        } else {
